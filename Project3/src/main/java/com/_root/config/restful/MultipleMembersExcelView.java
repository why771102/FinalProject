...
//		populateExcelCells(model, workbook, request);
//
//	}
//
...
//	}
//
//	private void populateExcelCells(Map<String, Object> model, Workbook workbook, HttpServletRequest request) {
...
//		
//        List<HallSaleBean> hsbList = (List<HallSaleBean>) request.getAttribute("hsbList");
//        
...
//			cell.setCellValue(hsb.getHallID());
//			
//			cell = row.createCell(colCount++);
...
//			cell = row.createCell(colCount++);
//			cell.setCellStyle(styleCenter);
//			cell.setCellValue(hsb.getOrderHours());
//			
//			cell = row.createCell(colCount++);
//			cell.setCellStyle(styleCenter);
//			cell.setCellValue(hsb.getHallSubtotal());
//		}
