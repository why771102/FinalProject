...
public class ShoppingCartController implements ServletContextAware {
	...
	public String showShoppingCartItem(@RequestParam("orderID") String orderID,
	...
	public String addProductsToShoppingCart(HttpServletRequest request, @RequestParam("prodID") String prodID,
		...
		if (!memberID.equals(0)) {
			...
			SCOrderDetailBean scodb = new SCOrderDetailBean(Integer.parseInt(qty), SCOrderID, Integer.parseInt(prodID));
