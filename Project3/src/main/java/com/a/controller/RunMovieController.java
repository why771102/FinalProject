...
//			
			...
			while (HallTime > 0) {
				...
				if (HallTime > runMovie_list.get(0).getRunningTime()) {
					...
					mService.sortPT(runMovie_list);
					System.out.println("1: "+HallTime+"runID: "+runMovie_list.get(0).getRb().getRunID()+" runTime:"+runMovie_list.get(0).getRunningTime());
...
//											showMovie_list.add(restTime);
							...
							RunCount++;
							System.out.println("3: "+HallTime+" r:"+RunCount+"  runMovie_list.size() - 1"+(runMovie_list.size() - 1));
						}
					}
