...
//	}
	...
	public String getHallStatus(String hallID) {
		...
		if(status == 0) {
			button += "<button class=\"checkout-button\" id=\"updateHallStatus\" onclick=\"updateHallStatus()\">關閉廳&raquo;</button>";
		}else {
			button += "<button class=\"checkout-button\" id=\"updateHallStatus\" onclick=\"updateHallStatus()\">開放廳&raquo;</button>";
		}
		return button;
	}
