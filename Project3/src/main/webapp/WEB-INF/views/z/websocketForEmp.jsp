...
<body>
	<section id="container">
		<header class="header black-bg">
			...
			<!--logo start-->
			<a href="index.html" class="logo"><b>76<span>影城</span></b></a>
			<!--logo end-->
					...
					<li id="header_inbox_bar" class="dropdown"><a
						...
						<ul class="dropdown-menu extended inbox">
							...
							<li><a href="index.html#"> <span class="photo"><img
										alt="avatar"
										src="${pageContext.request.contextPath}/img/ui-zac.jpg"></span>
							...
							<li><a href="index.html#"> <span class="photo"><img
										alt="avatar"
										src="${pageContext.request.contextPath}/img/ui-divya.jpg"></span>
							...
							<li><a href="index.html#"> <span class="photo"><img
										alt="avatar"
										src="${pageContext.request.contextPath}/img/ui-danro.jpg"></span>
							...
							<li><a href="index.html#"> <span class="photo"><img
										alt="avatar"
										src="${pageContext.request.contextPath}/img/ui-sherman.jpg"></span>
				...
				<ul class="sidebar-menu" id="nav-accordion">
					<p class="centered">
						<a href="profile.html"><img
							src="${pageContext.request.contextPath}/img/ui-sam.jpg"
...
<!-- 							</form> -->
		...
		<footer class="site-footer">
          ...
          -->
				...
				<a href="chat_room.html#" class="go-top"> <i
