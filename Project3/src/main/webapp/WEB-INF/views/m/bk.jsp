			...
			<section class="wrapper site-min-height">
				<div class="row mt">
					<div class="col-lg-12">
						...
						<br>
						<!-- chart -->
						<div id="container1" style="height: 300px; max-width: 500px; margin: 0 auto"></div>
						<br>
						<!-- timpicker -->
						<div style="display:flex;  justify-content: right;align-items: right;">
							<div id="timePicker"
								style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; width: 17%;
...
// 																			alert("搜尋成功!");
								...
								function editInfo(hall) {
									...
									var pieColors = (function() {
										var colors = [], base = Highcharts
												.getOptions().colors[0], i;
										for (i = 0; i < 10; i += 1) {
