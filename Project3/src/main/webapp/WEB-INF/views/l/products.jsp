...
<section id="container">
	...
	$(document).ready(function() {
		...
		$(function() {
			$.ajax({
				url : "${pageContext.request.contextPath}/productsAjax",
				type : "POST",
				success : function(data) {
					...
					$.each(data,function(index,value) {
						dataTable.row.add([
			value.productID, value.productName,value.categoriesBean.categoryName, value.unitPrice, value.unitStock, value.cost,
			function(data,type,row) {
				var html = "<a href='update/products/" + value.productID + "'>修改</a>";
				return html;
				} 
				]).draw();
			})
